...
- **BNS3 + BNS Wire** (2026-07-27): original data coding (string-pool TLV) and BNS3 container with codec race + SHA-256 seal; voice stays raw. Default writer remains zip-v2 (open transparency); `BnsPackers.compact` is BNS3. See `docs/bns-format.md`.
